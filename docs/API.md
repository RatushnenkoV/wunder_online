...
| GET | `/api/chat/rooms/<pk>/messages/` | member | Сообщения (пагинация) |
...
| PATCH | `/api/projects/<pk>/` | owner/teacher | Обновить проект |
| POST | `/api/projects/<pk>/members/` | owner | Добавить участника |
